...
#define VAL_GPIOB_AFRL      (PIN_AFIO_AF(GPIOB_BUZ, 2) |                    \
                             PIN_AFIO_AF(GPIOB_I2S3_CK, 6) |                \
                             PIN_AFIO_AF(GPIOB_I2S3_SD, 6) |                \
                             PIN_AFIO_AF(GPIOB_I2S3_CK, 0)   |              \
 ...
 * PF6  - GPIOF_STAT1           (alternate 3).
 * PF7  - GPIOF_STAT2           (alternate 3).
 * PF8  - GPIOF_STAT3           (output).
...
#define VAL_GPIOF_MODER     (PIN_MODE_INPUT(GPIOF_0) |                      \
                             ...
                             PIN_MODE_ALTERNATE(GPIOF_STAT2) |              \
...
#define VAL_GPIOF_AFRL      (PIN_AFIO_AF(GPIOF_STAT1, 3) |                  \
                             PIN_AFIO_AF(GPIOF_STAT2, 3))
#define VAL_GPIOF_AFRH       PIN_AFIO_AF(GPIOF_STAT3, 9)
 ...
 * PG10 - GPIOG_10              (output).
 * PG11 - GPIOG_LEFT            (input floating).
 * PG12 - GPIOG_12              (output).
...
#define VAL_GPIOG_MODER     (PIN_MODE_INPUT(GPIOG_0) |                      \
                             ...
                             PIN_MODE_OUTPUT(GPIOG_10) |                     \
                             PIN_MODE_INPUT(GPIOG_LEFT) |                   \
                             PIN_MODE_OUTPUT(GPIOG_12) |                     \
