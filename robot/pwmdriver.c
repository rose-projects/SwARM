...
static const unsigned int PWM_FREQUENCY_KHZ = 1;
...
void initPWM(void) {
	...
	TIM2->CNT    = 0x00;   // Reset both TIM counters to sync them
	TIM16->CNT   = 0x00;
