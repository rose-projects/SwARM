...
static void LcoderIRQ_cb(EXTDriver *extp, expchannel_t channel) {
    (void)extp;
    (void)channel;
...
static void RcoderIRQ_cb(EXTDriver *extp, expchannel_t channel) {
    (void)extp;
    (void)channel;
...
static const EXTConfig extcfg = {
    {
        ...
        {EXT_CH_MODE_RISING_EDGE | EXT_CH_MODE_AUTOSTART, LcoderIRQ_cb}, // 22 : COMP2 output
		...
		{EXT_CH_MODE_RISING_EDGE | EXT_CH_MODE_AUTOSTART, RcoderIRQ_cb} // 30 : COMP4 output
    }
};
