...
struct distOffset {
	...
	int16_t mbCoeff;   // linear coefficient from the master beacon in cm
	int16_t sb1Coeff;  // linear coefficient from the slave beacon 1 in cm
	int16_t sb2Coeff;  // linear coefficient from the slave beacon 2 in cm
};
